 ...
 * </split-button>
 *
 * Divider styles: vertical (default), forward (/), and reverse (\).
...
class SplitButton extends HTMLElement {
    ...
    get split() {
        ...
        return ['vertical', 'forward', 'reverse'].includes(value) ? value : 'vertical';
    }
        ...
        this.shadowRoot.innerHTML = `
            ...
            <div class="root" part="button">
                <div class="surface split-${split}" part="surface">
                    ...
                    <button class="side side-right" part="right" type="button"
