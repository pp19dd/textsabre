...
const unsigned long blink_interval_ms = 125;
...
void loop() {
    ...
    // used for button menu operation
    if( millis() - last_toggle_ms >= blink_interval_ms ) {
    ...
    if( current_edge == E_FALLING && prev_edge == E_RISING ) {
        ...
        // used for blue debug
        // turnoff_time = micros() + (circle_time / 360 ); // was 36 in millis()
